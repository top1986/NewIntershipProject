...
def prepare_data(data):
    ...
    try:
        ...
        trans = full_pipeline.fit_transform(data)

       

        joblib.dump(full_pipeline, 'spec_files/models/transformer.pkl', compress=1)
...
def load_trans():
    return joblib.load('ml/spec_files/models/transformer.pkl') 
